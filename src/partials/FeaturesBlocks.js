        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">
              SpaceTankは、 独自のワードリストの作成、
              他ユーザの作成したワードリストの登録、
              新しいワードの創出、ランダムな出力など、
              アイデアを作るために必要な様々な機能を提供します。
            </p>
          </div>
